...
// CopyClient is a client for copy_v2.  The source is a client for the source of the copy,
// target is a client for the target of the copy
...
// that you initialize and set the source / target client on your own.
